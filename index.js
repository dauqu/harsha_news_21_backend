...
const allowedOrigins = ["http://localhost:3001", "http://localhost:3000", "https://admin-for-all.vercel.app","https://harsha-news-21-frontend-ebsr5yren-dauqu.vercel.app"];
...
// app.use(`${apiv1}/comments_neeraj`, require("./routes/comments_neeraj"));
